import { getPosInScene } from "@/utils/threeHelper";
...
class SpritService{
  ...
  /*--------------------------------------- common ------------------------------------------*/
  public click2do(cb: (point: THREE.Intersection<THREE.Object3D<THREE.Object3DEventMap>>) => void) {
    window.addEventListener("click", (e) => getPosInScene()(e, cb), false);
  }

  public dispose(cb: (point: THREE.Intersection<THREE.Object3D<THREE.Object3DEventMap>>) => void) {
    window.removeEventListener("click", (e) => { getPosInScene()(e, cb) });
  }
